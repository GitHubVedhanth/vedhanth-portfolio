...
import { ArrowDown, Download, Eye, EyeClosed, Github, Linkedin, Mail } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div
          className="absolute top-0 -right-4 w-96 h-96 bg-accent rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute -bottom-8 left-20 w-96 h-96 bg-primary/70 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-float"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-1/4 left-1/4 w-2 h-2 bg-primary rounded-full animate-float opacity-60"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute top-1/3 right-1/3 w-3 h-3 bg-accent rounded-full animate-float opacity-40"
          style={{ animationDuration: "10s", animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-1/4 left-1/2 w-2 h-2 bg-primary rounded-full animate-float opacity-50"
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in-up">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative group floating">
              ...
              {/* Glowing Background */}
              <div
                className="absolute -inset-4 rounded-full opacity-60 group-hover:opacity-100 transition-all duration-500"
                style={{
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground/90">
            AI & ML Engineer | Full Stack Dev | Deep Learning Enthusiast
          </h2>

          {/* Tagline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            "Building intelligent systems that{" "}
            <span className="text-primary font-semibold">see</span>,
          ...
          <div className="flex flex-wrap gap-4 justify-center pt-6">
            ...
            <a
            href="https://drive.google.com/file/d/1U9Xd0DQtYPlwqWfNhtNI3_ffYXorXBrV/view?usp=drive_link"
            target="_blank"
